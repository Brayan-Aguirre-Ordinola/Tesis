...
tfinal_horas=1      #horas
tsalto_minutos=0    #min
Te_inicial=0        #°C / Opcional para cuando el salto es a un tiempo diferente de 0
Te_value=-10        #°C
mass_fruit=0        #kg
dt=10               #s
diff_ave=8.8        #°C
...
data_T["T_eva"]= np.where(tiempo >= tsalto, Te_value, Te_inicial)
...
folder_name = f'Intento_{current_time}'
